...
public class KitchenDialog extends JDialog {
	...
	private void initUI() {
		...
		nextOrderButton = new JButton(new ImageIcon(getClass().getResource("next order button.JPG")));
		...
		finishButton = new JButton(new ImageIcon(getClass().getResource("finished button.JPG")));
