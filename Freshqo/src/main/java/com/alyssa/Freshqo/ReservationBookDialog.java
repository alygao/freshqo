...
public class ReservationBookDialog extends JDialog {
	...
	private void initUI() {
		...
		addReservationButton = new JButton(new ImageIcon(getClass().getResource("add reservation button.JPG")));
		...
		cancelReservationButton = new JButton(new ImageIcon(getClass().getResource("cancel reservation button.JPG")));
